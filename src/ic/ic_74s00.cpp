...
IC_74S00::IC_74S00() : CallbackComponent("74S00") { set_description("Quad 2-In NAND"); }

void IC_74S00::install(Socket& socket) {
...
void IC_74S00::on_power_on() {
    update_outputs();
}

void IC_74S00::on_power_off() {
    for (auto& g : gates_)
        g.y.release();
}
