...
struct Board {
    ...
    IC_74S04<0x01>* inv51_ic = nullptr;     // U51
    ...
    void wire(const std::string& bios_path,
        ...
        inv_ic = inv_socket.emplace<IC_74S04<0x1B>>();
        ...
        inv51_ic = inv51_socket.emplace<IC_74S04<0x01>>();
        ...
        inv99_ic = inv99_socket.emplace<IC_74S04<0x2B>>();
